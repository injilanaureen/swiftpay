...
<head>
    <meta charset="utf-8" />
    <title>About Us - SwiftoPay | Payment Orchestration Platform</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta
      content="payment orchestration, payment gateway, fintech, SwiftoPay"
      name="keywords"
    />
    <meta
      content="Learn about SwiftoPay - Your comprehensive payment orchestration solution"
      name="description"
    />
 </head>
    <!-- Header Start -->
